...
//
//    /**
//     * Return true if currentUserEmail equals to leap.owner()
...
//
//    /**
//     * Adds values to a pre-existing HashMap for updating a property for all of the Leap copies.
...
//     * the Leap copies. This method uses {@link #updateMapForAllWithValue} to update the
//     * last changed timestamp for all Leap copies.
//     *
//     * @param sharedWith           The list of users the shopping list that has been updated is shared with.
//     * @param listId               The id of the shopping list.
//     * @param owner                The owner of the shopping list.
...
//    }
//    /**
//     * Once an update is made to a Leap, this method is responsible for updating the
...
//
//                    Leap list = dataSnapshot.getValue(Leap.class);
//                    if (list != null) {
...
//                         */
//                        HashMap<String, Object> updatedLeapData = new HashMap<String, Object>();
//
//                        updateMapForAllWithValue(sharedWith, listId, owner, updatedLeapData,
//                                timeReverseLocation, timeReverse);
//                        firebaseRef.updateChildren(updatedLeapData);
//                    }
//                }
//
//                @Override
